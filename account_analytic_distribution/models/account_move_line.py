...
class AccountMoveLine(models.Model):
    ...
    def action_show_distribution(self):
        ...
        """
        self.ensure_one()
        view = self.env.ref('account_analytic_distribution.account_move_line_distribution_form_view')
        return {
            "name": _("Distribution"),
            ...
            if line.analytic_line_ids:
                ...
                if -amount != line.debit and (
                    ...
                    raise ValidationError(
                        _("The total sum of amounts must be equal to the " +
