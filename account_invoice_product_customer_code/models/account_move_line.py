...
class AccountMoveLine(models.Model):
    ...
    def _compute_customer_product_code(self):
        for line in self:
            product_code = ""
            if (line.product_id and line.product_id.customer_code_ids and
                    line.move_id.partner_id):
                partner = (
                    line.move_id.partner_id if not
                    line.move_id.partner_id.parent_id else
                    line.move_id.partner_id.parent_id)
    ...
    def _compute_product_display_name(self):
        for line in self:
            ...
            if (line.move_id.move_type == "out_invoice" and
                ...
                line.customer_product_code and
