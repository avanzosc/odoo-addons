=====================================
Account invoice product customer code
=====================================
...
* In invoice line new fields "Customer product code".
* In the reports of out invoice, if the invoice line has the field "Customer
