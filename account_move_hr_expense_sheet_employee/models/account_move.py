...
class AccountMove(models.Model):
    ...
    hr_expense_sheet_ids = fields.One2many(
        string="", comodel_name="hr.expense.sheet",
        inverse_name="account_move_id", copy=False
    )
    employee_id = fields.Many2one(
        string="Employee", comodel_name="hr.employee", copy=False, store=True,
    ...
    def _compute_employee_id(self):
        for move in self:
            ...
            if move.hr_expense_sheet_ids:
                expenses = move.hr_expense_sheet_ids.filtered(
