...
class ProductFinalPriceByPricelist(models.Model):
    ...
    _depends = {
        ...
        "product.price.by.pricelist": [
            "product_id", "pricelist_id", "price_unit", "description_sale_es",
            "description_sale_en", "description_sale_cat"
        ],
    }

    def _select(self):
        return super(ProductFinalPriceByPricelist, self)._select() + \
    ...
    def _group_by(self):
        return super(ProductFinalPriceByPricelist, self)._group_by() + \
