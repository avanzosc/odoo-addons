...
class ProductInformativeLocation(models.Model):
    ...
    precision1_description = fields.Char(
        ...
        related="precision1_id.description",
        store=True,
    )
    ...
    precision2_description = fields.Char(
        ...
        related="precision2_id.description",
        store=True,
    )
    ...
    precision3_description = fields.Char(
        ...
        related="precision3_id.description",
        store=True,
    )
    ...
    @api.depends(
        ...
        "precision2_id.name",
        "precision3_id.name",
        "precision1_id.description",
        "precision2_id.description",
        "precision3_id.description",
    )
...
class ProductProduct(models.Model):
    ...
    product_location_ids = fields.One2many(
        string="Product informative locations",
