...
class ResPartnerImportLine(models.Model):
    ...
    def _action_validate(self):
        ...
        if self.import_id.company_id:
            self = self.with_context(force_company_id=self.import_id.company_id.id)
    ...
    def _check_partner(self):
        ...
        if self.import_id.company_id:
            partner_obj = partner_obj.with_context(
    ...
    def _update_partner(self):
        ...
        contact.with_context(
            no_vat_validation=True, force_company_id=self.import_id.company_id.id
