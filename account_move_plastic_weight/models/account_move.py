...
class AccountMove(models.Model):
    ...
    x_plastic_weight_non_recyclable_total = fields.Float(
        ...
        store=True,
        copy=True,
        help="Sum of the weight of non-recycled plastic (subject to IPNR) "
        "of all products on the invoice.",
    )
    x_plastic_weight_recyclable_total = fields.Float(
        string="Total recycled plastic (kg)",
        store=True,
        copy=True,
        help="Sum of the weight of recycled plastic (NOT subject to IPNR) "
        "of all products on the invoice.",
    )
    ...
    def _compute_plastic_weight_totals(self):
        for move in self:
            ...
            for line in move.invoice_line_ids:
                ...
                weight_non_recyclable = (
                    line.product_id.plastic_weight_non_recyclable or 0.0
                )
            ...
            move.write(
                {
                    "x_plastic_weight_non_recyclable_total": round(
                        total_non_recyclable, 6
                    ),
    ...
    def create(self, vals_list):
        ...
        moves._compute_plastic_weight_totals()
        return moves
