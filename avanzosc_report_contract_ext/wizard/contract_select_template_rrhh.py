...
class contract_select_template_rrhh(osv.osv_memory):

    _name = 'contract.select.template.rrhh'
    _description = "Wizard Select Template"
 
    _columns = {
        'contract_template_id':fields.many2one('report.contract.template', 'Contract Template',domain=[('contract_type','=','R')]),
         }

    #
    ### Función
    #
    def template_selected_rrhh(self, cr, uid, ids, context=None):
        #
        ...
        for wiz in self.browse(cr,uid,ids,context):
            ...
            for line1 in src_temp.general_conditions_lines_ids:
                ...
                data = {'contract_type':report_contract_template.contract_type,
                        ...
                        'hrcontract_order1_ids': [(6, 0, [simu_id])],
                        }
            ...
            for line1 in src_temp.particular_conditions_lines_ids:
                ...
                data = {'contract_type':report_contract_template.contract_type,
                        ...
                        'general_conditions':line1.general_conditions,
                        'particular_conditions':line1.particular_conditions,
                        'hrcontract_order2_ids': [(6, 0, [simu_id])],
                        }
