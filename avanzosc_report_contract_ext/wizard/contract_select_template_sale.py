...
class contract_select_template_sale(osv.osv_memory):

    _name = 'contract.select.template.sale'
    _description = "Wizard Select Template"
 
    _columns = {
        'contract_template_id':fields.many2one('report.contract.template', 'Contract Template',domain=[('contract_type','=','S')]),
         }

    #
    ### Función
    #
    def template_selected_sale(self, cr, uid, ids, context=None):
        #
