...
class EventEvent(models.Model):
    ...
    training_itinerary_courses_count = fields.Integer(
        string="Itinerary courses number",
        store=True,
        related="training_itinerary_id.courses_count",
    )
    event_courses_count = fields.Integer(string="Courses number")
    different_course_counters = fields.Boolean(
        string="Different course counters",
        store=True,
    ...
    def _compute_different_course_counters(self):
        for event in self:
            if event.training_itinerary_courses_count == event.event_courses_count:
