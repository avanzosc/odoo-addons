    ...
    def shop(
        ...
        **post,
        ...
        if filter_by_price_enabled:
            ...
            # to obtain the domain through the search metadata.
            Product = request.env["product.template"].with_context(bin_size=True)
            domain = self._get_search_domain(search, category, attrib_values)

            # This is ~4 times more efficient than a
            # search for the cheapest and most expensive products
            ...
            if min_price or max_price:
                ...
                # min exceeds the max, and / or the specified max
                # is lower than the available min.
                if min_price:
                    min_price = (
                        min_price
        ...
        prohibited_category_ids = user.related_prohibited_category_ids.ids

        filtered_product_ids = [
            product.id
            for product in products
            if product.categ_id.id not in prohibited_category_ids
        ]
