...
class StockMoveLine(models.Model):
    ...
    def _onchange_gross_weight(self):
        ...
        if self.gross_weight and self.product_uom_id.category_id == weight_categ:
            if self.product_packaging_id and self.product_packaging_id.weight and self.product_packaging_qty:
                qty_done -= self.product_packaging_id.weight * self.product_packaging_qty
    ...
    def _onchange_palet_qty(self):
        if (not self.no_update_palet_qty and self.product_id and
            self.product_packaging_id and self.palet_id and
            ...
            line = self.product_id.packaging_ids.filtered(
                ...
                x.name == self.product_packaging_id.name and
