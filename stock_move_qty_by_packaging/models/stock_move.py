...
class StockMove(models.Model):
    ...
    def _compute_palet_qty(self):
        for move in self:
            if move.move_line_ids:
                move.palet_qty = sum(
                    move.move_line_ids.mapped("palet_qty"))
            elif move.sale_line_id:
