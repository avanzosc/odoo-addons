...
class scholarship_line_teacher(osv.osv):
    
    _name = 'scholarship.line.teacher'
    _description = 'Scholarship Line Teacher'
...
class agreement(osv.osv):
    ...
    _columns = {
            ...
            'scholarship_des_teacher_ids':fields.one2many('scholarship.line.teacher','destination_id','Scholarship Teacher Lines(Destination)'),
            'scholarship_sou_teacher_ids':fields.one2many('scholarship.line.teacher','source_id',"Scholarship Teacher Lines(Source)"),
...
class scholarship(osv.osv):
    ...
    _columns = {
            ...
            'scholarship_line_teacher_ids':fields.one2many('scholarship.line.teacher', 'scholarship_id', 'Scholarships Lines(Teachers)'),
    }
scholarship()
