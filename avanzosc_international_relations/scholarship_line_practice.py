...
class scholarship_line_practice(osv.osv):
    
    _name = 'scholarship.line.practice'
    _description = 'Scholarship Line Practice'
...
class agreement(osv.osv):
    ...
    _columns = {
            ...
            'scholarship_des_practice_ids':fields.one2many('scholarship.line.practice','destination_id','Scholarship Practice Lines(Destination)'),
            'scholarship_sou_practice_ids':fields.one2many('scholarship.line.practice','source_id',"Scholarship Practice Lines(Source)"),
...
class scholarship(osv.osv):
    ...
    _columns = {
            ...
            'scholarship_line_practice_ids':fields.one2many('scholarship.line.practice', 'scholarship_id', 'Scholarships Lines(Practice Students)'),
    }
scholarship()
