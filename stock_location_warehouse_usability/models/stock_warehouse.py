...
class StockWarehouse(models.Model):
    ...
    street2 = fields.Char(string="Street 2", related="partner_id.street2", store=True)
    ...
    location_ids = fields.One2many(
        string="Locations", comodel_name="stock.location", inverse_name="warehouse_id"
    )
    location_count = fields.Integer("# Locations", compute="_compute_location_count")
