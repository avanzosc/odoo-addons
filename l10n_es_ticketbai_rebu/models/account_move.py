...
class AccountMove(models.Model):
    ...
    def tbai_prepare_invoice_values(self):
        ...
        for line in lines:
            ...
            if (self.company_id.tbai_protected_data and
                    self.company_id.tbai_protected_data_txt):
                description_line = self.company_id.tbai_protected_data_txt[:250]
            tbai_invoice_line_ids.append(
                (0, 0, {"description": description_line,
