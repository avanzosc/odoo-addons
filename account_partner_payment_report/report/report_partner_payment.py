...
# from openerp import pooler, exceptions, _
...
#             JOIN payment_mode pm on (pm.id=i.payment_mode_id)
#             JOIN account_payment_term pt on (pt.id=i.payment_term)
...
#         payment_mode = self._get_form_param('payment_mode', data)
...
#             stop = stop_period
#         if commercial_id:
#             domain = [('user_id', '=', commercial_id[0])]
#             if partner_ids:
...
#     def get_partners_move_lines_ids(self, account_ids, main_filter, start,
#                                   stop, target_move, exclude_reconcile=False,
...
#     def _get_partners_move_line_ids(self, filter_from, account_ids, start,
#                                     stop, target_move,
