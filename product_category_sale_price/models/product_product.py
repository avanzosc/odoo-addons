...
class ProductProduct(models.Model):
    ...
    my_standard_price = fields.Float(
        string='Total cost (base + extra)', default=1.0,
        digits=dp.get_precision('Product Price'),
        help="Price at which the product is sold to customers.")
    my_list_price = fields.Float(
        string='Sales Price', default=1.0,
        digits=dp.get_precision('Product Price'),
        help="Price at which the product is sold to customers.")
    ...
    def _onchange_category_sale_price(self):
        ...
        for product in self.filtered(
                lambda x: x.template_attributes_count == 0):
            product.price_cost_changed = True
    ...
    def put_product_info_in_template(self):
        ...
        if (template.product_category_sale_price_id !=
        ...
        if (template.new_product_category_sale_price_id !=
        ...
        template.write(vals)
        if (template.last_new_sale_price_change_date !=
        ...
        if (template.last_change_date_new_extra_cost !=
