...
class TestAccountBankingMandateUsability(AccountBankingMandateUsabilityCommon):
    ...
    def test_generate_banking_mandate_wizard_defaults(self):
        ...
        self.assertEqual(
            self.wizard_dict.get("bank_ids"), [(6, 0, self.bank.ids)])
        self.assertEqual(
            self.wizard_dict.get("mandate_format"),
            mandate_dict.get("format", False))
        self.assertEqual(
            self.wizard_dict.get("mandate_type"),
            mandate_dict.get("type", False))
        self.assertEqual(
            self.wizard_dict.get("mandate_scheme"),
