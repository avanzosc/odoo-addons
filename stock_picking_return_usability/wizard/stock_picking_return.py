...
class ReturnPicking(models.TransientModel):
    ...
    def _prepare_move_default_values(self, return_line, new_picking):
        ...
        if self.picking_id and (
            ...
            result.update({
                "location_id": self.picking_id.picking_type_id
                .return_picking_type_id.default_location_src_id.id or (
                    return_line.move_id.location_dest_id.id),
                "location_dest_id": self.picking_id.picking_type_id
                .return_picking_type_id.default_location_dest_id.id or (
                    self.location_id.id or return_line.move_id.location_id.id)
                })
        return result
    ...
    def _create_returns(self):
        ...
        if self.picking_id and (
            ...
            return_picking.write({
                "location_id": self.picking_id.picking_type_id
                .return_picking_type_id.default_location_src_id.id or self
                .picking_id.location_dest_id.id,
                "location_dest_id": self.picking_id.picking_type_id
                .return_picking_type_id.default_location_dest_id.id or self
                .location_id.id})
        if self.picking_id and (
            self.picking_id.picking_type_id) and (
