  ...
  !(function (z) {
    ...
    var I,
      ...
      S =
        ...
        (y = RegExp(x, "g")),
        function (e) {
          return (e = e == null ? "" : String(e)), $.test(e) ? e.replace(y, E) : e;
        });
    function E(e) {
      return I[e];
    }
    ...
    var G = new RegExp(B + "|" + M),
      ...
      Y = function (e, t, i) {
        ...
        return (
          ...
          void 0 !== t && t !== "" && (s.className = t),
          R.major === "4" && s.classList.add("dropdown-item"),
        ...
        createLi: function () {
          ...
          this.options.hideDisabled && (m += ":not(:disabled)"),
            (!c.options.showTick && !c.multiple) ||
              ...
              ((_.checkMark.className = f + " " + c.options.tickIcon + " check-mark"),
          ...
          function I(e, t) {
            if (
              ...
              t.display && (a += t.display.length),
                ...
                t.icon && (a += 1),
                d < a &&
                  ((d = a), (c.selectpicker.view.widestOption = v[v.length - 1]));
            }
          }
          function i(e, t) {
            var i = t[e],
        ...
        render: function () {
          ...
          if (
            ...
            for (var d = 0; d < n && d < 50; d++) {
              ...
              this.multiple && d > 0 && a.appendChild(l.cloneNode(!1)),
                h.title
                  ? (p.text = h.title)
        ...
        liHeight: function (e) {
          if (e || (!1 !== this.options.size && !this.sizeInfo)) {
            ...
            var v,
              ...
              $ = z(o).outerHeight(!0),
              y = Boolean(window.getComputedStyle) && window.getComputedStyle(i),
              S = i.offsetWidth,
              E = y ? null : z(i),
              C = {
                vert:
                    ...
                    if ((v && b) || (g && w))
                      if (v && v == 1)
                        ...
                        var k =
                          ...
                          $ = typeof k === "function" ? k(v, g) : k,
                          y = $[0].replace("{n}", v),
                          S = $[1].replace("{n}", g),
                          E = z('<div class="notify"></div>');
                        $[2] &&
                          ((y = y.replace("{var}", $[2][v > 1 ? 0 : 1])),
