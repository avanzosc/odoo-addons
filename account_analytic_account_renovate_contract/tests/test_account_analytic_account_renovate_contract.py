...
class TestAccountAnalyticAccountRenovateContract(common.TransactionCase):

    def setUp(self):
        super(TestAccountAnalyticAccountRenovateContract, self).setUp()
        ...
        line_vals = {'product_id': self.service_product.id,
                     ...
                     'price_unit': 100}
        account_vals = {'name': 'Analytic account renovate contract',
