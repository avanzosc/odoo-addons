...
class AccountMove(models.Model):
    ...
    def _compute_event_ticket_ids(self):
        for invoice in self:
            ...
            for line in invoice.invoice_line_ids:
                ...
                if line.event_ticket_id and line.event_ticket_id not in event_tickets:
    ...
    event_ticket_ids = fields.Many2many(
        ...
        relation="rel_invoice_event_ticket",
        column1="account_move_id",
        column2="event_ticket_id",
        compute="_compute_event_ticket_ids",
        store=True,
        copy=False,
    )
    ...
    event_ticket_id = fields.Many2one(
        ...
        copy=False,
        store=True,
        compute="_compute_count_event_ticket",
    )
