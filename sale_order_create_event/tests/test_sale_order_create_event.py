...
class TestSaleOrderCreateEvent(common.TransactionCase):
    ...
    def setUp(self):
        ...
        self.project_model = self.env['project']
        ...
        sale_vals.update({'project_id': self.account2.id,
                          'project_by_task': 'yes'})
    ...
    def test_sale_order_create_event_project_by_task(self):
        ...
        self.project2.tasks[0]._calc_num_sessions()
        self.project2.tasks[0].show_sessions_from_task()
        self.project2.tasks[0].button_recalculate_sessions()
        self.assertNotEqual(
            len(self.project2.tasks[0].sessions), 0,
