...
class PartnerPartner(models.Model):
    ...
    asociated = fields.Selection([('Yes', _('Yes')), ('No', _('No')),
        ('Asociated potential', _('Asociated potential'))], string="Asociated",
        default="Yes")
    asociated_type = fields.Selection([('Partner', _('Partner')),
        ('Parter/Junior', _('Partner/Junior')),
        ('Strategic Partner', _('Strategic Partner')),
        ('Strategic Partner Junior', _('Strategic Partner Junior'))],
        string="Asociated type", default="Partner")
    nature_entity = fields.Selection([('Company', _('Company')),
        ('Training center', _('Training center')),
    ...
    doyou = fields.Boolean(default=True,
...
class PartnerEconomic(models.Model):
    _inherit = 'res.partner'
