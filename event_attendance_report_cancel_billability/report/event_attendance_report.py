...
class EventAttendanceReport(models.Model):
    ...
    payable = fields.Float(string="Payable", readonly="1")
    billable = fields.Float(string="Billable", readonly="1")

    def _select_event_attendace_report(self):
        select = super(EventAttendanceReport, self)._select_event_attendace_report()
        return "{}, {}".format(select, "t.payable as payable, t.billable as billable")
