...
class ProductTemplate(models.Model):
    ...
    def _compute_labeled_length(self):
        ...
        for template in unique_variants:
            template.labeled_length = (
                template.product_variant_ids.labeled_length)
    ...
    @api.depends("product_variant_ids",
                 "product_variant_ids.description_label_es")
    ...
    @api.depends("product_variant_ids",
                 "product_variant_ids.description_label_fr")
    ...
    @api.depends("product_variant_ids",
                 "product_variant_ids.description_label_en")
    ...
    @api.depends("product_variant_ids",
                 "product_variant_ids.labeled_finished_code")
    ...
    @api.depends("product_variant_ids",
                 "product_variant_ids.labeled_color_es")
    ...
    @api.depends("product_variant_ids",
                 "product_variant_ids.labeled_color_fr")
    ...
    @api.depends("product_variant_ids",
                 "product_variant_ids.labeled_color_en")
    ...
    def create(self, vals_list):
        ...
        for template, vals in zip(templates, vals_list):
            ...
            if vals.get("description_label_es"):
                related_vals["description_label_es"] = (
                    vals["description_label_es"])
            if vals.get("description_label_fr"):
                related_vals["description_label_fr"] = (
                    vals["description_label_fr"])
            if vals.get("description_label_en"):
                related_vals["description_label_en"] = (
                    vals["description_label_en"])
            if vals.get("labeled_finished_code"):
                related_vals["labeled_finished_code"] = (
                    vals["labeled_finished_code"])
