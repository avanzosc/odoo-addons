...
class TestQcInspectionFromHrContract(common.TransactionCase):

    def setUp(self):
        super(TestQcInspectionFromHrContract, self).setUp()
    ...
    def test_qc_inspection_from_hr_contract(self):
