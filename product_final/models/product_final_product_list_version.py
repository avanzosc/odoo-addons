...
class ProductFinalProductListVersion(models.Model):
    _name = "product.final.product.list.version"
    _description = "Products list version"
    _order = "code"
    ...
    def _check_unique_code(self):
        for final in self:
            ...
            f = self.env["product.final.product.list.version"].search(cond, limit=1)
            if f:
                raise UserError(
                    _(
