...
class EventAttendanceReport(models.Model):
    ...
    event_id = fields.Many2one(string="Event", comodel_name="event.event", readonly="1")
    event_name = fields.Char(string="Event name", readonly="1")
    session_date = fields.Date(string="Session Date", readonly="1")
    planned_hours = fields.Float(string="Planned hours", readonly="1")
    real_hours = fields.Float(string="Real hours", readonly="1")
    customer_id = fields.Many2one(
        string="Customer", comodel_name="res.partner", readonly="1"
    )
    customer_name = fields.Char(string="Customer name", readonly="1")
    student_id = fields.Many2one(
        string="Student", comodel_name="res.partner", readonly="1"
    )
    student_name = fields.Char(string="Student name", readonly="1")
