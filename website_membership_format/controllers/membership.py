...
class WebsiteMembership(WebsiteMembership):
    ...
    def partners_detail(self, partner_id, **post):
        res = super().partners_detail(partner_id, **post)
    ...
    def members(
        ...
        **post
        ...
        res = super().members(membership_id, country_name, country_id, page, **post)
        ...
        res.qcontext["memberships_partner_ids"]["free"] = list(member_ids.keys())
        res.qcontext.update(
            {
    ...
    def recalculatePager(self, pager, zone, state, city):
        ...
        pager["page"]["url"] = pager["page"]["url"] + page_filter
        pager["page_first"]["url"] = pager["page_first"]["url"] + page_filter
        pager["page_start"]["url"] = pager["page_start"]["url"] + page_filter
        pager["page_previous"]["url"] = pager["page_previous"]["url"] + page_filter
        pager["page_next"]["url"] = pager["page_next"]["url"] + page_filter
        pager["page_end"]["url"] = pager["page_end"]["url"] + page_filter
        pager["page_last"]["url"] = pager["page_last"]["url"] + page_filter
