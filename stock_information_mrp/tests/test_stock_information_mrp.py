...
class TestStockInformationMrp(common.TransactionCase):

    def setUp(self):
        super(TestStockInformationMrp, self).setUp()
    ...
    def test_stock_information_mrp(self):
        ...
        for information in informations:
            information.show_incoming_pending_productions()
            information.show_draft_productions()
