...
class ReportLineagePercentageXlsx(models.AbstractModel):
    ...
    def generate_xlsx_report(self, workbook, data, objects):
        ...
        for line in objects:
            worksheet.write(
                n, 0, line.batch_id.name if line.batch_id else '')
            worksheet.write(
                n, 1, line.lineage_id.name if line.lineage_id else '')
            worksheet.write(
                n, 2, round(line.percentage, 3), three_decimal_format)
            worksheet.write(
                n, 3, fields.Date.from_string(
            ...
            worksheet.write(
                n, 5, line.warehouse_id.name if line.warehouse_id else '')
            ...
            worksheet.write(
                n, 11, round(line.growth_speed, 2), two_decimal_format)
            ...
            worksheet.write(
                n, 17, line.feed_family.name if line.feed_family else '')
            worksheet.write(
                n, 18, round(line.medicine_amount, 2), two_decimal_format)
            worksheet.write(
                n, 19, round(line.average_age, 2), two_decimal_format)
            worksheet.write(n, 20, line.farm_day, int_format)
            worksheet.write(
                n, 21, round(line.average_weight, 3), three_decimal_format)
            worksheet.write(
                n, 22, round(line.conversion, 3), three_decimal_format)
            worksheet.write(
                n, 23, round(line.dif_weight, 3), three_decimal_format)
            worksheet.write(
            ...
            worksheet.write(
                n, 27, round(line.cost_kilo, 3), three_decimal_format)
            n = n + 1
        worksheet.write(
        ...
        worksheet.write(
            n, 15, sum(objects.mapped("consume_feed")), int_format)
        worksheet.write(n, 16, round(sum(objects.mapped(
            "output_feed_amount")), 2), two_decimal_format)
        worksheet.write(n, 18, round(sum(objects.mapped(
        ...
        worksheet.write(n, 25, round(sum(objects.mapped(
