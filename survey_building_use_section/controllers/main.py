...
class Survey(Survey):
    ...
    def survey_display_page(self, survey_token, answer_token, **post):
        ...
        self._create_and_fill_normative_filters(
            res.qcontext["survey"], res.qcontext["answer"]
        )
                                    ...
                                    if triggering_question_to_filter.question_normative_ids:
                                        ...
                                        if any(
                                            ...
                                            matching_normative_names = [
                                                normative.name
                                                for normative in matched_normatives
                                            ]
                                            matched_answers = [
                                                ans
                                                for ans in triggering_question_id.suggested_answer_ids
