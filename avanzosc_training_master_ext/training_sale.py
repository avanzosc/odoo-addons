...
class sale_order(osv.osv):
    ...
    def create_record(self, cr, uid, ids, contacto, carrera, titulo, edicion):
        #OBJETOS#
        #######################################################
    ...
    def action_wait(self, cr, uid, ids, *args):
        ...
        create_record(self, cr, uid, ids, contacto, carrera, titulo, edicion)
#        existe_expediente = training_record_obj.search(cr,uid,[('student_id','=',contacto),('offer_id','=',carrera)]) 
#        if not existe_expediente:
#            #titulo
#            id_titulo = training_title_obj.search(cr,uid,[('name','=',titulo)])[0]
...
#                #Lincar seances ¿como?
        ...
        if edicion2:
            create_record(self, cr, uid, ids, contacto, carrera2, titulo2, edicion2)
