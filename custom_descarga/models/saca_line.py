...
class SacaLine(models.Model):
    ...
    craw_percentage = fields.Float(
        compute="_compute_craw_percentage", store=True, group_operator="avg"
    )
    ...
    dock_temperature = fields.Float(copy=False, group_operator="avg")
    dock_relative_humidity = fields.Float(copy=False, group_operator="avg")
    asphyxiated_percentage = fields.Float(copy=False, group_operator="avg")
    asphyxiated_wight = fields.Float(copy=False)
    seizured_percentage = fields.Float(copy=False, group_operator="avg")
    seizured_wight = fields.Float(copy=False)
    stunning = fields.Float(copy=False, group_operator="avg")
    second_percentage = fields.Float(copy=False, group_operator="avg")
    dirty_feather_g1 = fields.Float(copy=False, group_operator="avg")
    dirty_feather_g2 = fields.Float(copy=False, group_operator="avg")
    dirty_feather = fields.Float(compute="_compute_dirty_feather", group_operator="avg")
    living_stunned = fields.Float(copy=False, group_operator="avg")
    living_stunned_estimated = fields.Float(
        compute="_compute_living_stunned_estimated", group_operator="avg"
    )
    hard_breast = fields.Float(copy=False, group_operator="avg")
    hard_breast_estimated = fields.Float(
        compute="_compute_hard_breast_estimated", group_operator="avg"
    )
    wing_injury = fields.Float(copy=False, group_operator="avg")
    wing_injury_estimated = fields.Float(
        compute="_compute_wing_injury_estimated", group_operator="avg"
    )
    thingh_injury = fields.Float(copy=False, group_operator="avg")
    thingh_injury_estimated = fields.Float(
        compute="_compute_thingh_injury_estimated", group_operator="avg"
    )
    breast_injury = fields.Float(copy=False, group_operator="avg")
    breast_injury_estimated = fields.Float(
        compute="_compute_breast_injury_estimated", group_operator="avg"
    )
    back_injury = fields.Float(copy=False, group_operator="avg")
    back_injury_estimated = fields.Float(
        compute="_compute_back_injury_estimated", group_operator="avg"
    )
    hock_injury = fields.Float(copy=False, group_operator="avg")
    hock_injury_estimated = fields.Float(
        compute="_compute_hock_injury_estimated", group_operator="avg"
    )
    podpdermattis_g1 = fields.Float(copy=False, group_operator="avg")
    podpdermattis_g2 = fields.Float(copy=False, group_operator="avg")
    podpdermattis = fields.Float(compute="_compute_podpdermattis", group_operator="avg")
    gizzard_injury = fields.Float(copy=False, group_operator="avg")
    gizzard_injury_estimated = fields.Float(
        compute="_compute_gizzard_injury_estimated", group_operator="avg"
    )
    liver_injury = fields.Float(copy=False, group_operator="avg")
    liver_injury_estimated = fields.Float(
        compute="_compute_liver_injury_estimated", group_operator="avg"
    )
    heart_injury = fields.Float(copy=False, group_operator="avg")
    heart_injury_estimated = fields.Float(
        compute="_compute_heart_injury_estimated", group_operator="avg"
    )
    bowel_injury = fields.Float(copy=False, group_operator="avg")
    bowel_injury_estimated = fields.Float(
        compute="_compute_bowel_injury_estimated", group_operator="avg"
    )
    weighting = fields.Float(compute="_compute_weighting", group_operator="avg")
